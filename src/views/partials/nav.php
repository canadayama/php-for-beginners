              ...
              <div class="ml-4 flex items-center md:ml-6">
                ...
                <div class="relative ml-3">
                    <div>
                        ...
                        <?php else : ?>
                            <a href="/register" class="<?= urlIs('/register') ? 'bg-gray-900 text-white' : 'bg-gray-300' ?> hover:bg-gray-700 hover:font-white px-3 py-2 rounded-md text-sm font-medium">Register</a>
                            <?php if (!urlIs('/login')) : ?>
                            <a href="/login" class="<?= urlIs('/login') ? 'bg-gray-900 text-white' : 'bg-gray-300' ?> hover:bg-gray-700 hover:font-white px-3 py-2 rounded-md text-sm font-medium">Login</a>
                            <?php endif ?>
                        <?php endif ?>
                    </div>
